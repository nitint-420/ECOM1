...
const income = entries.filter((e: Entry) => e.type === "INCOME").reduce((s, e: Entry) => s + e.amount, 0);
const expense = entries.filter((e: Entry) => e.type === "EXPENSE").reduce((s, e: Entry) => s + e.amount, 0);
  return (
